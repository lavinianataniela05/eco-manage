                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    />
                    <button
                      type="button"
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <input
                        ...
                        className="w-20 text-center px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                        min="1"
                      />
                      <button
                        type="button"
